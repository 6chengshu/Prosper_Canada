...
print(in_path+'FEPS_dboOutcomes.csv')

#OFEC

df = pd.read_excel(in_path+'redcap_data.xlsx')
...
project = pd.read_excel(in_path + 'project_id.xlsx')
...
#FEPS
#Import service info
df = pd.read_csv(in_path+"FEPS_dboServices.csv",
...
#import outcome info
df_2 = pd.read_csv(in_path+'FEPS_dboOutcomes.csv',
                 skipinitialspace = True,
                 usecols = range(0,7),
                 dtype = {"Agency":"str",
                          "SessionID":"str",
...
FEPS = master.loc[:,['Agency','year','quarter']]
...
agency = pd.read_excel(in_path+'Agency_id.xlsx')
...
mastertable.to_excel(out_path, sheet_name='Master')